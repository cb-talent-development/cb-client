    ...
    module Resources
      class Users < ResourceBase
        def check_existing(email, password)
          v2.post(APIs::V2::Endpoints::USERS_CHECK_EXISTING, Email: email, Password: password)
        end
        ...
        def temporary_password(external_id)
          v1.get(APIs::V1::Endpoints::USERS_TEMPORARY_PASSWORD, ExternalID: external_id)
        end

        def retrieve(external_id)
          v2.post(APIs::V2::Endpoints::USERS_GET, ExternalID: external_id)
        end
        ...
        def delete(external_id)
          v2.post(APIs::V2::Endpoints::USERS_DELETE, ExternalID: external_id)
        end
      end
    end
  end
